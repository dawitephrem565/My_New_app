...
public class Main_Page_listIteam {
    private int gid;
    private String aid;
    ...
    public Main_Page_listIteam(int gid, String aid, String gname, String gimages, String desc, String date, String status, String price) {
        this.gid = gid;
        this.aid = aid;
        this.gname = gname;
